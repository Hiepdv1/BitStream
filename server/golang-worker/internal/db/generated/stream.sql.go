...
type BulkInsertChatMessagesParams struct {
	ID            string
	Opcode        int32
	StreamId      string
	UserId        pgtype.Text
...
func (q *Queries) CreateStreamEvent(ctx context.Context, arg CreateStreamEventParams) error {
	_, err := q.db.Exec(ctx, createStreamEvent,
		arg.ID,
		arg.StreamId,
		arg.Type,
		arg.Payload,
...
func (q *Queries) CreateStreamMeta(ctx context.Context, arg CreateStreamMetaParams) error {
	_, err := q.db.Exec(ctx, createStreamMeta,
		arg.ID,
		arg.StreamId,
		arg.SegmentDuration,
		arg.Timescale,
...
func (q *Queries) DisableStreamKey(ctx context.Context, streamid string) error {
	_, err := q.db.Exec(ctx, disableStreamKey, streamid)
	return err
}

const existStreamIsLive = `-- name: ExistStreamIsLive :one
SELECT EXISTS (
  SELECT 1
  FROM "Stream"
  WHERE id = $1
...
func (q *Queries) ExistStreamIsLive(ctx context.Context, id string) (bool, error) {
	row := q.db.QueryRow(ctx, existStreamIsLive, id)
	var exists bool
	err := row.Scan(&exists)
	return exists, err
}
...
func (q *Queries) ExistStreamMeta(ctx context.Context, streamid string) (bool, error) {
	row := q.db.QueryRow(ctx, existStreamMeta, streamid)
	var exists bool
	err := row.Scan(&exists)
	return exists, err
}
...
func (q *Queries) GetActiveStreamKey(ctx context.Context, streamid string) (StreamKey, error) {
	row := q.db.QueryRow(ctx, getActiveStreamKey, streamid)
	var i StreamKey
	err := row.Scan(
		&i.ID,
		&i.StreamId,
...
func (q *Queries) GetOldEndedStreamIDs(ctx context.Context, endedat pgtype.Timestamptz) ([]string, error) {
	rows, err := q.db.Query(ctx, getOldEndedStreamIDs, endedat)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetRecordingsByStream(ctx context.Context, streamid string) ([]Recording, error) {
	rows, err := q.db.Query(ctx, getRecordingsByStream, streamid)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
// ============================================
func (q *Queries) GetStoppedStreamIDs(ctx context.Context, createdat pgtype.Timestamptz) ([]string, error) {
	rows, err := q.db.Query(ctx, getStoppedStreamIDs, createdat)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetStreamEvents(ctx context.Context, arg GetStreamEventsParams) ([]StreamEvent, error) {
	rows, err := q.db.Query(ctx, getStreamEvents, arg.StreamId, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
SELECT id, "streamId", "totalDuration", "segmentCount", "lastSegmentSeq", "segmentDuration", timescale, "videoRepId", "audioRepId", "basePath", "sourceWidth", "sourceHeight", ladders, "vodManifestUrl", "createdAt", "updatedAt" FROM "StreamMeta"
WHERE "streamId" = $1
`
...
func (q *Queries) GetStreamMeta(ctx context.Context, streamid string) (StreamMetum, error) {
	row := q.db.QueryRow(ctx, getStreamMeta, streamid)
	var i StreamMetum
	err := row.Scan(
		&i.ID,
		&i.StreamId,
...
func (q *Queries) ListLiveStreams(ctx context.Context, limit int32) ([]Stream, error) {
	rows, err := q.db.Query(ctx, listLiveStreams, limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type SetStreamStartedParams struct {
	ID        string
	StartedAt pgtype.Timestamptz
}

func (q *Queries) SetStreamStarted(ctx context.Context, arg SetStreamStartedParams) error {
	_, err := q.db.Exec(ctx, setStreamStarted, arg.ID, arg.StartedAt)
	return err
}

const setVodManifestUrl = `-- name: SetVodManifestUrl :exec
UPDATE "StreamMeta"
...
type SetVodManifestUrlParams struct {
	StreamId       string
	VodManifestUrl pgtype.Text
}

func (q *Queries) SetVodManifestUrl(ctx context.Context, arg SetVodManifestUrlParams) error {
	_, err := q.db.Exec(ctx, setVodManifestUrl, arg.StreamId, arg.VodManifestUrl)
	return err
}
...
func (q *Queries) TouchStreamKey(ctx context.Context, streamid string) error {
	_, err := q.db.Exec(ctx, touchStreamKey, streamid)
	return err
}
...
func (q *Queries) UpdateStreamInfo(ctx context.Context, arg UpdateStreamInfoParams) error {
	_, err := q.db.Exec(ctx, updateStreamInfo,
		arg.ID,
		arg.Title,
		arg.Description,
		arg.Visibility,
...
func (q *Queries) UpdateStreamMeta(ctx context.Context, arg UpdateStreamMetaParams) error {
	_, err := q.db.Exec(ctx, updateStreamMeta,
		arg.StreamId,
		arg.TotalDuration,
		arg.SegmentCount,
		arg.LastSegmentSeq,
...
func (q *Queries) UpdateStreamMetaWithSegments(ctx context.Context, arg UpdateStreamMetaWithSegmentsParams) error {
	_, err := q.db.Exec(ctx, updateStreamMetaWithSegments,
		arg.StreamId,
		arg.TotalDuration,
		arg.SegmentCount,
		arg.LastSegmentSeq,
...
const updateStreamResolution = `-- name: UpdateStreamResolution :exec
UPDATE "StreamMeta"
SET "sourceWidth" = $2,
    "sourceHeight" = $3,
    "ladders" = $4,
...
type UpdateStreamResolutionParams struct {
	StreamId     string
...
func (q *Queries) UpdateStreamResolution(ctx context.Context, arg UpdateStreamResolutionParams) error {
	_, err := q.db.Exec(ctx, updateStreamResolution,
		arg.StreamId,
		arg.SourceWidth,
		arg.SourceHeight,
		arg.Ladders,

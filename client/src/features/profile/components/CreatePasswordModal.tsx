...
import { useSetupPassword } from "../hook/useSetupPassword";
...
interface CreatePasswordModalProps {
  isOpen: boolean;
  connectedAccounts: React.Dispatch<React.SetStateAction<ConnectedAccount[]>>;
  onClose: () => void;
}
...
export const CreatePasswordModal = ({
  ...
  const { invalidateProfileExtensions } = useAppQueryClient();
